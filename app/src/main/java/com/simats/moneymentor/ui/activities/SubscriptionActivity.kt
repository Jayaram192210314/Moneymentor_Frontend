package com.simats.moneymentor.ui.activities
...
class SubscriptionActivity : AppCompatActivity(), PurchasesUpdatedListener {
    ...
    companion object {
        ...
        private const val SUBSCRIPTION_SKU = "moneymentor_premium_subscription"
    ...
    private fun addDebugInformation() {
        ...
        try {
            ...
            Log.d(TAG, "Version code: ${androidx.core.content.pm.PackageInfoCompat.getLongVersionCode(packageInfo)}")
